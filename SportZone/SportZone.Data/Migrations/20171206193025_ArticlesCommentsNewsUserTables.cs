...
{
    public partial class ArticlesCommentsNewsUserTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCommentDate = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<byte[]>(maxLength: 51200, nullable: true),
                    IsEdited = table.Column<bool>(nullable: false),
                    LastEditedDate = table.Column<DateTime>(nullable: true),
                    PublishDate = table.Column<DateTime>(nullable: false),
                    Title = table.Column<string>(maxLength: 200, nullable: false),
                    VideoUrl = table.Column<string>(maxLength: 11, nullable: true)
                },
                constraints: table =>
                {
